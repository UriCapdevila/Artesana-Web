...
import type { ImagePlaceholder } from '@/shared/assets/placeholder-images';
...
export default function HeroSection({ heroImage }: { heroImage: ImagePlaceholder }) {
  return (
    <section className="relative h-[75vh] min-h-[500px] max-h-[700px] w-full flex items-center justify-center text-center text-white rounded-lg overflow-hidden shadow-2xl">
      ...
      >
        <motion.h1
          className="font-headline text-fluid-hero font-bold text-white drop-shadow-lg"
          variants={itemVariants}
        >
          El Alma en Cada Detalle
        </motion.h1>
        <motion.p
          className="text-fluid-xl text-stone-100 max-w-3xl mx-auto drop-shadow-md"
          variants={itemVariants}
        >
        ...
        <motion.div variants={itemVariants}>
          <Button
            asChild
            size="lg"
            className="mt-6 text-lg group transition-transform duration-300 hover:scale-105"
          >
            <Link href="/products">
              Explorar Creaciones{' '}
